...
Declare ML Module "rocq-plugin-tutorial.rocq_z3".
...
Ltac2 @external question : int -> bool
  := "rocq-plugin-tutorial.rocq_z3" "the_question".

(** a wrapper around "exact" *)
Ltac2 @external tuto_exact : constr -> unit
  := "rocq-plugin-tutorial.rocq_z3" "my_exact".
...
Ltac2 @external ind_or_a : custom -> bool
  := "rocq-plugin-tutorial.rocq_z3" "is_ind_or_a".
...
Ltac2 @external check_in_goal : ident -> custom
  := "rocq-plugin-tutorial.rocq_z3" "check_in_goal".
...
Ltac2 @external mk_custom2 : int -> int -> custom2
  := "rocq-plugin-tutorial.rocq_z3" "mk_custom2".

(** Get something from a custom2 value. *)
Ltac2 @external sum2 : custom2 -> int
  := "rocq-plugin-tutorial.rocq_z3" "sum2".
